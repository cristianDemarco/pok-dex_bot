...
class PokemonAPI:
    ...
    def get_api_data(self, pokemon : str) -> None:
        ...
        find_first_pokemon_variety = species_data_response["varieties"][0]["pokemon"]["name"]
        data_response = requests.get(f"https://pokeapi.co/api/v2/pokemon-species/{find_first_pokemon_variety}")
