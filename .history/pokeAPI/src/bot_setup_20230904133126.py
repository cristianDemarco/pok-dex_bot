...
async def search_pokemon(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    keyboard = [
        [
            InlineKeyboardButton("Option1", callback_data="/pokemon pikachu"),
            InlineKeyboardButton("Option2", callback_data="/pokemon chimchar"),
        ],
        InlineKeyboardButton("Option3", callback_data="/pokemon charizard"),
    ]
