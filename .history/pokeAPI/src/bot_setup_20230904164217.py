...
def button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if "/pokemon" in query.data:
        search_pokemon(update, context, True, query.data)


async def search_pokemon(update: Update, context: ContextTypes.DEFAULT_TYPE, is_callback : bool = False, callback_pokemon_name : str = "Undefined") -> None:
    if not is_callback:
    ...
    keyboard = [
        [
            InlineKeyboardButton(text = "Option1", callback_data="/pokemonnchimchar"),
