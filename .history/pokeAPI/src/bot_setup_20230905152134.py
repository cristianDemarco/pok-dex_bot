...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if "/pokemon" in query.data:
        ...
        await search_pokemon(update, context, callback_query_info, context)


async def search_pokemon(update: Update, context: ContextTypes.DEFAULT_TYPE, callback_query_info : dict = {"is_Callback" : False}, context) -> None:
